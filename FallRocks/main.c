...
int main(void)
{
	...
	EnvItem envItems[] = {
        ...
        {{ -20*T, 0, 40*T, 15*T }, BROWN, 'F' },
        {{ 20*T, 1*T, 80*T, 14*T }, BROWN, 'F' },
        {{ 40*T, -6*T, 8*T, 21*T }, BROWN, 'F' },
        {{ 55*T, -11*T, 8*T, 26*T }, BROWN, 'F' },
        {{ 70*T, -16*T, 8*T, 31*T }, BROWN, 'F' },
        {{ 78*T, -18*T, 24*T, 33*T }, BROWN, 'F' },
